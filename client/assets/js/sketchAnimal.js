...
return `<!-- ${species} ------------------------------------------------>
    <div class='${species + ' ' + Id}'>
        ...
        <div class='${species + ' ' + Id} head movingHead'>
            ...
            <div class="${sspecies + ' ' + Id} mouth-contour"></div>
            <div class="${sspecies + ' ' + Id} mouth-left"></div>
            <div class="${sspecies + ' ' + Id} mouth-right"></div>
            <div class="${sspecies + ' ' + Id} whiskers-left"></div>
        ...
        <div class='${species + ' ' + Id} body'>
            ...
            <div class="${sspecies + ' ' + Id} paw-right_rear"></div>
